...
class SubstationalphaFile extends File
{
	 ...
	 * @throws \Exception
	 */
	public function setMultiStyles( $_styles ) {
		if ( is_array( $_styles ) && is_array( $_styles[ 0 ] ) ) {
			$this->multistyles = $_styles;
		}
		else {
			throw new \Exception( 'Styles are not properly formated.' );
		}
	}

	public function getMultiStyles() {
